...
<div class="box">
    <form action="${pageContext.request.contextPath}/Register_teacher" method="post">
        <table>
            <caption class="register-caption" style="font-size: 50px">教师注册</caption>
            <tr>
                <td><label style="font-size: 30px;">账号: </label><input type="text" name="tech_ID"
                                                                         style="font-size: 24px;"
                                                                         class="text-input">
                </td>
            </tr>
            <tr>
                <td><label style="font-size: 30px;">密码: </label><input type="password" name="tech_pwd"
                                                                         style="font-size: 24px;" class="text-input">
                </td>
            </tr>
            <tr>
                <td><label style="font-size: 30px;">姓名: </label><input type="text" name="tech_name"
                                                                         style="font-size: 24px;" class="text-input">
                </td>
            </tr>

            <tr>
                <td><label style="font-size: 30px;">邮箱: </label><input type="text" name="teacher_Mail"
                                                                         style="font-size: 24px;" class="text-input">
                </td>
            </tr>
        </table>
